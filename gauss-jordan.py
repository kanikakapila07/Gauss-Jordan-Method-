...
#Problem: Solving system of linear equations using Gauss-Jordan method
...
def main():
    ...
    #if solvable is true, then calculate using gauss-jordan method
    if solvable(matrix):
        x = gauss_jordan(matrix, vector)
